...
class DSN(nn.Module):
    def __init__(self, code_size=100, n_class=2):#######2
        ...
        self.source_encoder_conv.add_module('conv_pse1', nn.Conv1d(in_channels=9, out_channels=32, kernel_size=5,
                                                                padding=2))######9
        ...
        self.source_encoder_fc.add_module('fc_pse3', nn.Linear(in_features=64, out_features=code_size))
        ...
        self.target_encoder_conv.add_module('conv_pte1', nn.Conv1d(in_channels=9, out_channels=32, kernel_size=5,
                                                                padding=2))#######9
        ...
        self.target_encoder_fc.add_module('fc_pte3', nn.Linear(in_features=64, out_features=code_size))
        ...
        self.shared_encoder_conv.add_module('conv_se1', nn.Conv1d(in_channels=9, out_channels=32, kernel_size=5,
                                                                  padding=2))########9
        ...
        self.shared_encoder_fc.add_module('fc_se3', nn.Linear(in_features=48, out_features=code_size))
        ...
        self.shared_encoder_pred_class.add_module('fc_se5', nn.Linear(in_features=100, out_features=1))
        ...
        self.shared_decoder_fc.add_module('fc_sd1', nn.Linear(in_features=code_size, out_features=9))#######9
        self.shared_decoder_fc.add_module('relu_sd1', nn.ReLU(True))

        self.shared_decoder_conv = nn.Sequential()
        self.shared_decoder_conv.add_module('conv_sd2', nn.Conv1d(in_channels=9, out_channels=16, kernel_size=5,
                                                                  padding=2))########9
        ...
        self.shared_decoder_conv.add_module('conv_sd6', nn.Conv1d(in_channels=16, out_channels=9, kernel_size=3,
                                                                  padding=1))#######9
    ...
    def forward(self, input_data, mode, rec_scheme, p=0.0):
        ...
        if mode == 'source':
            ...
            private_feat = private_feat.view(-1, 64)
        ...
        shared_feat = shared_feat.view(-1, 48)
